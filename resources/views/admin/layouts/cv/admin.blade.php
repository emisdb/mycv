...
<head>
    ...
    <title>AdminLTE 4 | General UI Elements</title><!--begin::Primary Meta Tags-->
...
<div class="app-wrapper" id="app"> <!--begin::Header-->
    @include('admin.layouts.cv.top-nav')
    @include('admin.layouts.cv.side-nav')
    @yield('content')
    @include('admin.layouts.cv.footer')
