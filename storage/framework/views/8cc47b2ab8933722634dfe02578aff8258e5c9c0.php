...
<html lang="en">
<head>
    <title><?php echo $__env->yieldContent('title-text'); ?></title>
    <meta charset="UTF-8">
...
<nav class="w3-sidebar w3-black w3-animate-right w3-xxlarge" style="display:none;padding-top:150px;right:0;z-index:2"
    ...
    <div class="w3-bar-block w3-center">
        ...
        <a href="<?php echo e(route('edu')); ?>" class="w3-bar-item w3-button w3-text-grey w3-hover-black"
...
<?php /**PATH /home/denis/projects/my/web/mycv/resources/views/layouts/main.blade.php ENDPATH**/ ?>