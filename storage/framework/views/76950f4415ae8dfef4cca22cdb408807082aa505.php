<div id="diaog-box" class="w3-modal">
    <div class="w3-modal-content w3-animate-zoom">
        <div id="container-box" class="w3-container  w3-display-container">
            <span onclick="document.getElementById('diaog-box').style.display='none'" class="w3-button w3-display-topright w3-large">x</span>
            <div class="w3-row">
...
<script type="text/javascript">
    var colors = ['blue', 'green', 'pink', 'yellow', 'gray'];
...
<?php /**PATH /home/denis/projects/my/web/mycv/resources/views/inc/modals_index.blade.php ENDPATH**/ ?>